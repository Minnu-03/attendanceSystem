...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','cyan-turtles-pump.loca.lt','.ngrok-free.app','4822-49-204-212-45.ngrok-free.app', '0.0.0.0'] #192.168.0.11 my ip address
CSRF_TRUSTED_ORIGINS = ['https://4822-49-204-212-45.ngrok-free.app']
CSRF_TRUSTED_ORIGINS = ['https://*.ngrok-free.app']
CSRF_FAILURE_VIEW = 'django.views.csrf.csrf_failure'
CSRF_COOKIE_SECURE = False  #  True if serving over HTTPS
CSRF_USE_SESSIONS = False  
CSRF_TRUSTED_ORIGINS = ['https://4fc8-49-204-212-45.ngrok-free.app']  # Replace with your actual Ngrok URL
